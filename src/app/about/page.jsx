...
export default function page() {
  return (
    ...
    <main className='mx-10'>
        <h1 className='md:flex md:justify-center ml-[150px] mt-[150px] text-[60px] font-bold text-[#1d2951]'>ABOUT US</h1>
        ...
        <h3 className='md:ml-[300px] ml-[200px] text-2xl text-[#1d2951]'> Our Mission</h3><br />
